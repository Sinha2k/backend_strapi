...
export interface ApiApplyApply extends Schema.CollectionType {
  ...
  attributes: {
    job: Attribute.Relation<'api::apply.apply', 'oneToOne', 'api::job.job'>;
...
export interface ApiEmployeeEmployee extends Schema.CollectionType {
  ...
  attributes: {
    ...
    appliedJob: Attribute.Relation<
      'api::employee.employee',
      'oneToMany',
      'api::job.job'
    >;
    savedJob: Attribute.Relation<
      'api::employee.employee',
      'oneToMany',
      'api::job.job'
    >;
    placeJob: Attribute.JSON;
    desiredJob: Attribute.JSON;
    exp: Attribute.Integer & Attribute.Required & Attribute.DefaultTo<0>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiJobJob extends Schema.CollectionType {
  ...
  attributes: {
    ...
    salary: Attribute.JSON & Attribute.Required;
    experiment: Attribute.JSON & Attribute.Required;
    company: Attribute.Relation<
      'api::job.job',
      'oneToOne',
      'api::company.company'
